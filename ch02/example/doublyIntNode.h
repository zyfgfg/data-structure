...
typedef struct DoublyIntNode {
    // 指向上一个节点
    struct DoublyIntNode *prev;
    // 指向下一个节点
    struct DoublyIntNode *next;
    // 保存的值
    int value;
} DoublyIntNode;
...
void doublyIntNodeDestroy(DoublyIntNode *);

void doublyIntNodeDisplay(const DoublyIntNode *);
